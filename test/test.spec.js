...
describe('Validation of credit card numbers', () => {
    describe('cardValidator', () => {
        ...
        it('testing of an Aura credit card number with spaces', () => {
            expect(cardNumber.cardValidator('5064 5678 8179 1081')).to.equal(true)
        })

        it('testing of an Aura credit card number with spaces and in incorrect digit', () => {
            expect(cardNumber.cardValidator('5064 5671 8179 1081')).to.equal(false)
        })

        it('testing of an Aura credit card number without any spaces', () => {
            expect(cardNumber.cardValidator('5047556291279599')).to.equal(true)
        })

        it('testing of an Aura credit card number without any spaces and with an incorrect digit', () => {
            expect(cardNumber.cardValidator('5047556291279592')).to.equal(false)
        })
